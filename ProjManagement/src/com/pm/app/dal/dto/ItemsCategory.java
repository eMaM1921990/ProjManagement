...
{
	/** 
	 * This attribute maps to the column id in the items_category table.
	 */
	protected int id;

	/** 
	 * This attribute maps to the column name in the items_category table.
	 */
	protected String name;

	/** 
	 * This attribute maps to the column branch_id in the items_category table.
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof ItemsCategory)) {
			return false;
		}
		
		final ItemsCategory _cast = (ItemsCategory) _other;
		if (id != _cast.id) {
			return false;
		}
	 ...
	 * Method 'createPk'
	 * 
	 * @return ItemsCategoryPk
	 */
	public ItemsCategoryPk createPk()
	{
		return new ItemsCategoryPk(id);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.pm.app.dal.dto.ItemsCategory: " );
		ret.append( "id=" + id );
