...
/**
 * Servlet implementation class BPedit
 */
@WebServlet("/BPedit")
public class BPedit extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			dto=businessObj.getBusinessPartnerForUpdate(dto);
			request.setAttribute("data", dto);
			RequestDispatcher redirect=request.getRequestDispatcher("/settingMenu/bp/edit.jsp");
