...
<div id="content-wrapper">
				<ul class="breadcrumb breadcrumb-page">
					...
					<li ><a href="#"><fmt:message key="menu.editbp"></fmt:message></a></li>
				</ul>
				...
				<div class="page-header">
					...
					<div class="row">
						...
						<h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;<fmt:message key="menu.editbp"></fmt:message></h1>
					</div>
			...
			<div class="panel">
				<div class="panel-heading">
						<span class="panel-title"><fmt:message key="menu.editbp"></fmt:message></span>
				</div>
				<div class="panel-body">
					<form class="form-horizontal" id="jq-validation-form" action="BPcontrol" method="POST">
						...
						<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="name" name="name" value="${d.name }" placeholder="<fmt:message key="label.bpname"></fmt:message>">
								</div>
						</div>
						<div class="form-group">
								<label for="jq-validation-email" class="col-sm-3 control-label"><fmt:message key="label.address"></fmt:message></label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="address" name="address" value="${d.address }" placeholder="<fmt:message key="label.address"></fmt:message>">
								</div>
						</div>
						...
						<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="phone" name="phone" value="${d.phone }" placeholder="<fmt:message key="label.phone"></fmt:message>">
								</div>
						</div>
						...
						<div class="form-group">
								...
								<div class="col-sm-9">
									<select name="working_as" id="working_as" class="form-control" >
													<option></option>
													<c:forEach items="${datatype}" var="t">
													<option value="${t.idbusinessPartnerType}">${t.type}</option>
													</c:forEach>
						...
						<div class="form-group">
								<div class="col-sm-offset-3 col-sm-9">
									<button type="submit" class="btn btn-warning" value="edit" name="control"><fmt:message key="label.edit"></fmt:message></button>
